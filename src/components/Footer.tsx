export function Footer() {
    return (
        <footer className="footer sm:footer-horizontal bg-primary-content text-neutral-content justify-center items-center p-4">
