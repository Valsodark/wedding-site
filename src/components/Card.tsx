            ...
            <div className="hero">
                <div className="card pt-5 bg-base-200 md:w-180 shadow-sm">
                    ...
                    <div className="card-body gap-6 text-center">
                        ...
                        <p className="text-lg">С радост и с трепет в душите, ви каним да споделите с нас един от най-вълнуващите моменти в
                            животите ни, а именно стъпването ни в брак. В този специален момент искаме да споделим
